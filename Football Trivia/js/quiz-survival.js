...
DG.QuizMaker = new Class( {
	...
	internal : {
		questionIndex : 0,
		questions : null,
		labelAnswerButton : 'Submit Answer'
	},
...
//JS for the Answer Button
	...
	_sendAnswer : function() {
		...
		//This code makes the quiz stop at 100 questions
		if (this.internal.questionIndex == 100) {
			this._clearEl();
	...
	//the 100 is the no. of questions to be asked
	getScore : function() {
		var ret = {
			numCorrectAnswers : 0,
			numQuestions : 100,
		...
		//the 100 is the no. of questn to be asked
		ret.numCorrectAnswers = numCorrectAnswers;
		ret.percentageCorrectAnswers = Math.round(numCorrectAnswers/100*100);
